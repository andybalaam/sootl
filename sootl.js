...
var _andybalaam$sootl$Main$updateMoveBase = F2(
...
var _andybalaam$sootl$Main$nullSpriteFrame = {
	hitboxes: {ctor: '[]'},
	svgs: {ctor: '[]'}
};
var _andybalaam$sootl$Main$isPlayerAlive = function (model) {
	var _p0 = model.player.deathTime;
	if (_p0.ctor === 'Nothing') {
		return true;
	} else {
		return false;
				...
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fontFamily('arial,sans-serif'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$fontVariant('small-caps'),
										_1: {
											ctor: '::',
	...
	function (model, time) {
		return {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$transform('scale(2.1,2.1)'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fill('#00ff00'),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$r('9.174984'),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_elm_lang$svg$Svg$path,
							{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$d('m -8.8934451,-4.1049 17.5271741,-5e-4 c -1.81995,6.5151 -5.462861,6.9077 -8.641304,2.6902 -3.287813,4.1465 -7.8469406,3.7682 -8.8858701,-2.6897 z'),
											_1: {ctor: '[]'}
										}
									}
								}
								...
								_elm_lang$svg$Svg$path,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$d('m -4.5727929,3.7212 c 1.6559109,2.4074 5.7333219,1.5495 8.9673909,1.2228'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _andybalaam$sootl$Main$combine = F2(
	function (f1, f2) {
		return {
			hitboxes: A2(_elm_lang$core$Basics_ops['++'], f1.hitboxes, f2.hitboxes),
			svgs: A2(_elm_lang$core$Basics_ops['++'], f1.svgs, f2.svgs)
		};
	});
var _andybalaam$sootl$Main$parallel = F7(
	function (sprite1, sprite2, lastFrame, deltaT, model, point, time) {
		return A2(
			_andybalaam$sootl$Main$combine,
			A5(sprite1, lastFrame, deltaT, model, point, time),
			A5(sprite2, lastFrame, deltaT, model, point, time));
	});
var _andybalaam$sootl$Main$still = function (sprite) {
	return sprite;
};
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill('#443333'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _andybalaam$sootl$Main$levelDef = function (level) {
	var _p2 = level;
	return _p2._0;
};
...
var _andybalaam$sootl$Main$intersect = F2(
	function (s1, s2) {
		...
		var _p5 = s2;
		return _elm_lang$core$Native_Utils.cmp(
			A2(_andybalaam$sootl$Main$dist, _p4._0, _p5._0),
			_p4._1 + _p5._1) < 0;
	});
var _andybalaam$sootl$Main$baseMessage = F5(
	function (time, tstart, tlength, p, txt) {
		...
		if (_elm_lang$core$Native_Utils.cmp(t, 0) < 0) {
			...
			var sz = 1 + (t * 0.4);
			return (_elm_lang$core$Native_Utils.cmp(op, 0) < 0) ? {ctor: '[]'} : {
				ctor: '::',
				_0: A7(
...
var _andybalaam$sootl$Main$LevelPointDef = F2(
	function (a, b) {
		return {x: a, y: b};
	});
...
var _andybalaam$sootl$Main$Resize = F2(
	function (a, b) {
		return {ctor: 'Resize', _0: a, _1: b};
	});
var _andybalaam$sootl$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(
				function (size) {
					return A2(_andybalaam$sootl$Main$Resize, size.width, size.height);
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$animation_frame$AnimationFrame$times(
					function (time) {
						return _andybalaam$sootl$Main$NewFrame(time);
					}),
				_1: {ctor: '[]'}
			}
		});
...
var _andybalaam$sootl$Main$pt = F2(
	function (x, y) {
		return _andybalaam$sootl$Main$LevelPoint(
			{x: x, y: y});
	});
var _andybalaam$sootl$Main$ptadd = F2(
	function (p1, p2) {
		var c2 = _andybalaam$sootl$Main$coords(p2);
		var c1 = _andybalaam$sootl$Main$coords(p1);
		return A2(_andybalaam$sootl$Main$pt, c1.x + c2.x, c1.y + c2.y);
	});
var _andybalaam$sootl$Main$moved = F7(
	function (offsetP, sprite, lastFrame, deltaT, model, point, time) {
		return A5(
			sprite,
			lastFrame,
			deltaT,
...
var _andybalaam$sootl$Main$message = F9(
	function (startT, endT, deltaP, txt, lastFrame, deltaT, model, point, time) {
		...
		var t = _andybalaam$sootl$Main$secs(time) - _andybalaam$sootl$Main$secs(startT);
		var sz = 1 + (t * 0.4);
		var op = 1.0 * ((_andybalaam$sootl$Main$secs(endT) - _andybalaam$sootl$Main$secs(startT)) - t);
		var svgs = (_elm_lang$core$Native_Utils.cmp(op, 0) < 0) ? {ctor: '[]'} : {
			ctor: '::',
			_0: A7(
				_andybalaam$sootl$Main$textSvg,
				pp.x,
...
var _andybalaam$sootl$Main$circling = function (centre) {
	return function (radius) {
		return function (startAngle) {
			return function (circleTime) {
							...
							return function (model) {
								return function (point) {
									return function (time) {
										var t = _andybalaam$sootl$Main$secs(time);
										var theta = ((_elm_lang$core$Basics$pi * 2) * t) / circleTime;
										var i = theta + startAngle;
										var c = _andybalaam$sootl$Main$coords(centre);
										var x = c.x + (radius * _elm_lang$core$Basics$sin(i));
										var y = c.y + (radius * _elm_lang$core$Basics$cos(i));
...
var _andybalaam$sootl$Main$circleSprite = F7(
	function (colour, size, lastFrame, deltaT, model, point, time) {
		...
		return {
			hitboxes: {
				ctor: '::',
				_0: A3(_andybalaam$sootl$Main$makeCircle, p.x, p.y, size),
				_1: {ctor: '[]'}
			},
			svgs: {
				ctor: '::',
...
var _andybalaam$sootl$Main$ti = function (t) {
	return _andybalaam$sootl$Main$LevelTime(t);
};
var _andybalaam$sootl$Main$timeSlice = F8(
	function (sliceTime, before, after, lastFrame, deltaT, model, point, time) {
		var st = _andybalaam$sootl$Main$secs(sliceTime);
		var t = _andybalaam$sootl$Main$secs(time);
		return (_elm_lang$core$Native_Utils.cmp(
			_andybalaam$sootl$Main$secs(time),
			_andybalaam$sootl$Main$secs(sliceTime)) < 0) ? A5(before, lastFrame, deltaT, model, point, time) : A5(
			after,
			lastFrame,
			deltaT,
			model,
			point,
			_andybalaam$sootl$Main$ti(t - st));
	});
var _andybalaam$sootl$Main$slide = function (sliceTime) {
	return function (startP) {
		return function (endP) {
					...
					return function (lastFrame) {
						return function (deltaT) {
							return function (model) {
								return function (point) {
									return function (time) {
										var endTT = _andybalaam$sootl$Main$secs(sliceTime);
										...
										var sliced = A3(
											...
											sliceTime,
											A2(_andybalaam$sootl$Main$moved, p, during),
											after);
										return A5(sliced, lastFrame, deltaT, model, point, time);
									};
								};
							};
						};
...
var _andybalaam$sootl$Main$introCircle = function () {
	...
	var msg1 = A4(
		...
		'Stay away');
	var c = _andybalaam$sootl$Main$whiteCircle;
	var stayAwayCircle = A2(
		_andybalaam$sootl$Main$parallel,
		A2(_andybalaam$sootl$Main$parallel, msg1, msg2),
		c);
	return A3(
		_andybalaam$sootl$Main$timeSlice,
		_andybalaam$sootl$Main$ti(4),
		A2(
			_andybalaam$sootl$Main$moved,
			A2(_andybalaam$sootl$Main$pt, 200, -70),
			c),
		A5(
			_andybalaam$sootl$Main$slide,
			_andybalaam$sootl$Main$ti(1),
...
var _andybalaam$sootl$Main$level0 = _andybalaam$sootl$Main$Level(
	{
		...
		sprites: {
			ctor: '::',
			_0: _andybalaam$sootl$Main$introCircle,
			_1: {
				ctor: '::',
				_0: _andybalaam$sootl$Main$introTwin,
				_1: {ctor: '[]'}
			}
		},
		bases: {
			ctor: '::',
			_0: A3(_andybalaam$sootl$Main$makeCircle, -40, 0, 20),
			_1: {
				ctor: '::',
				_0: A3(_andybalaam$sootl$Main$makeCircle, 40, 0, 20),
				_1: {ctor: '[]'}
...
var _andybalaam$sootl$Main$levels = {
	ctor: '::',
	_0: _andybalaam$sootl$Main$level0,
	_1: {ctor: '[]'}
};
...
var _andybalaam$sootl$Main$viewRestartButton = function (model) {
	...
	if (_andybalaam$sootl$Main$isPlayerAlive(model)) {
		...
		var md = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Events$onMouseDown(_andybalaam$sootl$Main$RestartClicked),
			_1: {ctor: '[]'}
		};
		return {
			ctor: '::',
			_0: A7(_andybalaam$sootl$Main$textSvg, 0, 80, 3, '#55ffff', 0.9, 'Try again', md),
			_1: {ctor: '[]'}
		};
	}
};
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill('#ff3100'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$stroke('#000000'),
									_1: {
								...
								_elm_lang$svg$Svg$path,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$d('m -7.7,-5.7 16.7303048,5.2248 c -0.459938,0.7095 -0.918545,1.3192 -1.372437,1.8333 -0.453892,0.5141 -0.960714,0.097 -1.401791,0.4236 l -0.920862,0.4509 -0.67903,-2.5808 -1.252743,1.3298 -0.88384,-1.5369 -1.359301,1.4435 -1.180369,-1.3734 c -4.3744806,2.9777 -8.6135091,1.2574 -7.6799318,-5.2165 z'),
												_1: {ctor: '[]'}
											}
										}
									}
									...
									_elm_lang$svg$Svg$path,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$d('m -4.5727929,4.2212 c 6.5205429,-1.4331 9.0681149,-1.0832 8.9673909,1.2228'),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _andybalaam$sootl$Main$viewPlayer = function (model) {
	...
	var render = _andybalaam$sootl$Main$isPlayerAlive(model) ? _andybalaam$sootl$Main$playerHappyFace : _andybalaam$sootl$Main$playerSadFace;
...
var _andybalaam$sootl$Main$nullTime = _andybalaam$sootl$Main$LevelTime(0);
var _andybalaam$sootl$Main$spriteFrame = F2(
	function (model, sprite) {
		var time = _andybalaam$sootl$Main$levelTime(model);
		return A5(
			sprite,
			_andybalaam$sootl$Main$nullSpriteFrame,
			_andybalaam$sootl$Main$nullTime,
			model,
			_andybalaam$sootl$Main$LevelPoint(
				{x: 0, y: 0}),
			time);
...
var _andybalaam$sootl$Main$viewBase = F4(
	function (model, time, which, baseShape) {
		var md = _andybalaam$sootl$Main$isPlayerAlive(model) ? {
			ctor: '::',
...
var _andybalaam$sootl$Main$viewBases = function (model) {
	var time = _andybalaam$sootl$Main$levelTime(model);
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _andybalaam$sootl$Main$view = function (model) {
	...
	var ty = _elm_lang$core$Basics$toFloat(sh - min) / 2;
	var tx = _elm_lang$core$Basics$toFloat(sw - min) / 2;
	var trans = A2(
		_elm_lang$core$Basics_ops['++'],
		'translate(',
		A2(
					...
					A2(
						...
						A2(
							...
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$toFloat(min) / 200),
							'),translate(100, 100)'))))));
	var time = _andybalaam$sootl$Main$levelTime(model);
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_andybalaam$sootl$Main$viewBackgrounds(model),
					A2(
						_elm_lang$core$Basics_ops['++'],
						_andybalaam$sootl$Main$viewBases(model),
						A2(
							_elm_lang$core$Basics_ops['++'],
...
var _andybalaam$sootl$Main$main = _elm_lang$html$Html$programWithFlags(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _andybalaam$sootl$Main$main !== 'undefined') {
    _andybalaam$sootl$Main$main(Elm['Main'], 'Main', undefined);
}
